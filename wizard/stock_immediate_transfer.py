...
class StockImmediateTransfer(models.TransientModel):
    ...
    def process(self):
        ...
        # If the immediate transfer wizard

        print('1111')
        # process all our picking but with some back order maybe needed we want to add the backorder already passed to the wizard.
